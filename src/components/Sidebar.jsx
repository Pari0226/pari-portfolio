...
export default function Sidebar() {
  return (
    <div className="flex flex-col gap-4">
      {/* Profile Image Card */}
      <div className="bg-[#1F1F1F] rounded-2xl border border-[#1F1F1F] overflow-hidden aspect-[3/4] flex items-center justify-center sm:w-full w-full">
        <img 
          src="/profile.jpg" 
          alt="Pari" 
      ...
      {/* Name Block */}
      <div>
        <h2 className="text-xl font-bold text-white mb-0.5">Pari Singh</h2>
      ...
      <div className="flex items-center gap-2 pt-2 w-full">
        ...
        <a href="/CV.pdf" target="_blank" rel="noopener noreferrer" className="flex-1 py-2 px-3 rounded-lg bg-[#FFC8DD] text-black text-xs font-semibold hover:bg-opacity-90 transition-all text-center">
          View CV
        </a>
      </div>
